...
<p>
	<label for="sk_rss">
		<input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id('rss'); ?>" name="<?php echo $this->get_field_name('rss'); ?>"<?php if ((int)$instance['rss']) {
		  echo " checked";
		} ?>/> <?php _e('Show RSS feed', 'sk'); ?>
	</label>
</p>
